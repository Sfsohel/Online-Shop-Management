...
echo "<table>";
 echo "<tr>";
 echo   "<td rowspan='3' style='width:100%'>";
   echo '<img src="data:image/jpeg;base64,'.base64_encode($row['photo'] ).'" height="200" width="200"/>';
 echo "</td>";
   echo  "<td style='width:30%'>"."catname:".$row["prodname"]."</td>";
  echo"</tr>";
 echo "<tr>";
    
   echo "<td style='width:30%'>"."Description:".$row["sortdes"]."</td>";
  echo "</tr>";
  echo "<tr>";
    
   echo "<td>"."price:".$row["priceinfo"]."</td>";
  echo "</tr>";
  echo "<tr>";
  echo "<a class='btn' href='show.php?id=".$row["id"]."'>BUY</a>";
  echo "</tr>";
  echo "</table>";
		}
