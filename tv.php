...
<?php
   ...
   $total="select * from product where service='TV' and validity='accepted'";
   ...
   if(isset($_GET['page'])&& !empty($_GET['page']))
   {
	...
	$sql = "select * from product where service='TV' and validity='accepted' limit $item_per_page offset $offset";
